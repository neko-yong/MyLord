...
class DevScenarioTests(unittest.TestCase):
    ...
    def test_developer_enablement_has_no_frontend_bypass(self):
        ...
        self.assertIn("if admin_route:", source)
    ...
    def test_fast_local_disables_only_automatic_fragment_polling(self):
        ...
        self.assertIn("database.get_case_revision(case_id, role)", app_source)
        self.assertIn('@observe_fragment("mediation_room")', app_source)
